...
/* Общее количество мест для каждого рейса
Находим по общему количеству мест в самолете, 
забронированному на данный рейс*/
...
--Вариант 1
--Для начала находим стоимость перелетов по городам и классам
...
--Вариант 2
--Для начала находим максимальные и минимальные стоимость перелетов по городам и классам для Economy и Business
...
--8. Между какими городами нет прямых рейсов? Решение без представлений
...
-- Можно сделать и без ранее созданного представления, просто тогда cte будет включать в себя его логику				-- В итоговом запросе добавляем информацию из таблицы aircraft
